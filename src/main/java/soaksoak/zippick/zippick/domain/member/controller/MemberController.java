package soaksoak.zippick.zippick.domain.member.controller;

import soaksoak.zippick.zippick.domain.member.dto.MemberJoinRequestDto;
import soaksoak.zippick.zippick.domain.member.dto.MemberLoginRequestDto;
import soaksoak.zippick.zippick.domain.member.dto.MemberLoginResponseDto;
import soaksoak.zippick.zippick.domain.member.dto.RefreshTokenRequestDto;
import soaksoak.zippick.zippick.domain.member.service.MemberService;
import soaksoak.zippick.zippick.domain.member.service.RefreshTokenService;
...
public class MemberController {
    ...
    public ResponseEntity<String> delete(@PathVariable Long memberId) {
        return ResponseEntity.ok().body(memberService.delete(memberId));
    }
